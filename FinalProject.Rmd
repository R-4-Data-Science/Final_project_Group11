...
subtitle: |
  ...
  <br>Vignette Report
  <img width="15" height="15" src="https://img.icons8.com/office/40/link.png" alt="link"/>
  <span style="font-size:70%"><https://raw.githack.com/R-4-Data-Science/Final_project_Group11/main/mpssAIC/vignettes/diabetes_mpssAIC.html></span>
...
model_type = "gaussian",
B = 50, # reduced for knitting speed; use 50+ in final
...
Here we use the synthetic Gaussian regression data defined above, with a continuous response generated from a sparse true β.
...
delta = 2,
L = 50,
B = 50, # reduced for knitting speed; 50+ recommended
resample_type = "bootstrap",
m = NULL,
Delta = 2,
tau = 0.6
...
2. **Real-World Application (Package Vignette):**
   ...
   For the report on Vignette, please read the other separate HTML file `diabetes_mpssAIC.html` due to its length. The report can also be accessed at <https://raw.githack.com/R-4-Data-Science/Final_project_Group11/main/mpssAIC/vignettes/diabetes_mpssAIC.html>.
...
The code for the Shiny app is in `helpers.R` in the `mpssAIC/R` directory and in `app.R` in the `mpssAIC/inst/shiny-examples/mpssAIC-demo` directory.

### Run Shiny App
To run the Shiny app, after installing the package following Section 1, at the R command prompt, run
```{r, eval=FALSE}
library(mpssAIC)
mpssAIC:::run_mpssAIC_demo()
```

### Screenshots of Shiny App

Because the HTML generated by `.Rmd` cannot show dynamic content, we only include screenshots of the app the message submission: also it is part of file in the github.

Screenshot 1: <https://raw.githack.com/R-4-Data-Science/Final_project_Group11/main/screenshot1.png>

Screenshot 2: <https://raw.githack.com/R-4-Data-Science/Final_project_Group11/main/screenshot2.png>
