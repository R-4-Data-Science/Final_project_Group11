...
Some portions of the documentation, code refinement, and explanatory text were produced with assistance from an AI language model (ChatGPT). All algorithm design decisions, implementation logic, and final verification were performed by the authors. Link: 
