...
Because the HTML generated by `.Rmd` cannot show dynamic content, we only include screenshots of the app in the submission: also it is part of file in the github.
